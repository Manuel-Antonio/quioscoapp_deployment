  ...
  return (
    <div className="shadow p-5 mb-3 flex flex-col md:flex-row gap-10 items-center">
      ...
      <div className="md:w-4/6">
        ...
        <p className="text-md font-bold mt-2 text-indigo-500">
      ...
      <div>
        <button
          ...
          onClick={() => handleEditarCantidades(producto)}
        >
          <svg
        ...
        <button
          type="button"
          className="bg-red-600 flex mt-3 gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full"
